...
label2=Label(root,text=f'SCORE \n PLAYER1: {ScoreX}<==>PLAYER2: {ScoreO}',font="Times 15 bold",bg='cadet blue',fg='black',bd=4,height=1,width=10,relief=RAISED,)
label2.grid(row=4,column=0,padx=5,pady=5,sticky='nsnew')

label3=Label(root,text='PLAYER 1',font="Times 15 bold",bg='sky blue',fg='black',bd=4,height=2,width=10,relief=RAISED,)
label3.grid(row=0,column=0,padx=5,pady=5,sticky='nsnew')

label4=Label(root,text='PLAYER 2',font="Times 15 bold",bg='grey',fg='black',bd=4,height=2,width=10,relief=RAISED,)
...
b10=Button(root,font="Times 15 bold",image=b10Photo ,bg='cadet blue',fg='cadet blue',height=2,width=10)
...
def SetLayout(id,PlayerSymbol,colr):
    ...
    if id==1:
        ...
        b9['bg']=colr
        Count= Count+1
def AssignSeperateColorToLoser():
        b1['bg']='red'
        b2['bg']='red'
        b3['bg']='red'
        b4['bg']='red'
